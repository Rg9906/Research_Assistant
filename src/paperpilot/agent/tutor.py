...
SYSTEM_PROMPT_TEMPLATE = (
    ...
    "2. Answer using whatever relevant material the context does contain, and say plainly "
    "which parts of the question it does not cover. Reply with exactly "
    "'I cannot find the answer in the provided text.' ONLY when the context contains nothing "
